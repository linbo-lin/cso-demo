...
pub struct IndexDesc {
    ...
    key_columns_count: usize,
}

impl IndexDesc {
    pub fn new(mdid: u64, name: String, index_type: IndexType, key_columns_count: usize) -> Self {
        Self {
            mdid,
            name,
            index_type,
